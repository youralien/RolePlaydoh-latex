...
Though we focus on counseling, the insights from Roleplay-doh's design and evaluation can be applicable in areas beyond mental health as well. Through this human-LLM collaboration pipeline, experts in various domains are empowered to create custom LLM simulations via the incorporation of qualitative feedback.
